				...
				<ul class="nav nav-list">
					...
					<li class="">
						<a href="#" class="dropdown-toggle">
							...
							<span class="menu-text"> Group forum </span>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="alert">
									...
									<strong>Info!</strong> You can join or exit groups from here.
								</div>
                                <form class="form-horizontal" method="post" action="joingroup.php">
									...
									<?php
										...
										}elseif(isset($group_exists) && $group_exists){
											echo "<p style=\"color: red;\">*",htmlspecialchars($group_exists),"</p>\n\n";
										}
								  	?>
                                ...
                                <table>
										...
										<tbody>
											<?php
												...
												$sql = "SELECT * from groups_org where user=$id";
                                                $query = mysqli_query($conn, $sql);
                                                ...
                                                while ($row = mysqli_fetch_array($query)){
													...
													<td><a href="exitgroup.php?id='.$row['id'].'">Exit group</a></td>
                                                     </tr>';
                                                }
									...
									<?php
										if(isset($exit_error) && $exit_error) {

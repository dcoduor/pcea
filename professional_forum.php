				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Congregational Forum</li>
						</ul><!-- /.breadcrumb -->
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="alert">
									...
									<strong>Info!</strong> All congregational members can perticipate in this forum.
								</div>
                                    

                                        <form action="professional_forum_topic.php" name="group" method="post">
										...
										<div id="read">
											<a href="myprof_forum.php" >Follow discussions</a>
										</div>
										<?php

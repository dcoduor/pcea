						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="alert">
									...
									<strong>Info!</strong> You can send a direct message to the administrator.
								</div>
                                <form class="form-horizontal" method="post" action="addcomment.php">
                                    <input type="hidden" name="uname" value="<?=$login_session;?>">
                                    <div class="form-group">
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Subject" name="heading" class="col-xs-10 col-sm-5" />
										</div>
									</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
										    <textarea class="form-control" id="form-field-8" placeholder="Your Comments" name="comment" class="col-xs-10 col-sm-5" ></textarea>
                                        </div>
									</div>
                                    <div class="form-group">
										<div class="col-sm-9">

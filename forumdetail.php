					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
                                    <?php
										$sql = "SELECT * FROM forum_topic WHERE id = '".$_GET['id']."'" or die(mysqli_error());
                                        $query = mysqli_query($conn, $sql);
                                    ...
                                    ?>
									<form action="forum_comment.php" method="post">
									...
									<tbody>
										<?php
											...
											$selectmemmbers = "select * from members_org, 
																forum_comments
																where members_org.id=forum_comments.user
																and forum_comments.topic=$topic_id";

							...
							<div class="col-xs-12">
								...
								<!-- PAGE CONTENT BEGINS -->
								 <form action="add_user.php" method="post">
                                    ...
                                    <input id="activation-email" placeholder="Phone Number" type="text" name="phone" >
                                    <input id="activation-email" placeholder="Member Registration Number" type="text" name="rsn" >
                                    <input id="activation-email" placeholder="Email Address" type="text" name="email" >
                                    <select id="activation-email" name="status">

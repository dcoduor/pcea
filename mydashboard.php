						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="alert">
									...
									<strong>Welcome</strong> to the P.C.E.A Makadara members portal.
								</div>
								...
								<div class="col-sm-6">
									<table id="example" class="display" width="100%" cellspacing="0">
											...
											<tbody>
												<?php 
													$sql = "SELECT * from groups_org, group_msg_org where groups_org.church_group=group_msg_org.team and groups_org.user='$id' ORDER BY group_msg_org.post_time DESC";
													$query = mysqli_query($conn, $sql);
													while ($row = mysqli_fetch_array($query))
													{  
	    												echo'<tr>

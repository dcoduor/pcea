					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
                                ...
                                <form class="form-horizontal" method="post" action="joinpgroup.php">
                                ...
                                <table>
										...
										<tbody>
											<?php
												...
												$sql = "SELECT * from prof_groups_org where user=$id";
                                                $query = mysqli_query($conn, $sql);
                                                ...
                                                while ($row = mysqli_fetch_array($query)){
													...
													<td><a href="exitpgroup.php?id='.$row['id'].'">Exit group</a></td>
                                                     </tr>';
                                                }
